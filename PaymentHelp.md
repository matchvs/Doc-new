...
先使用服务，每天的 24:00 ，jdge 系统对每个区域的每个游戏，实际使用的 CCU 和 流量进行结算，实际扣费时间以账单为准。
...
在套餐有效期内，jdge 允许每个自然月2次 ，每次 48 小时的CCU 用量缓冲，并会提供邮箱/短信告警服务。
...
jdge 下发的代金券可以直接当现金使用，可用于"后付费"的每天结算，也可以用于购买套餐或流量包。
...
jdge 提供的流量包，在“后付费”和“预付费”游戏均可使用。
...
接入jdge 的游戏可上线到中国区域和美国区域，更多区域会逐步推出。
